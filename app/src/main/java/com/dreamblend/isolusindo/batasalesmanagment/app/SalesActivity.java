...
public class SalesActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Receiving Intent from Sls_step_0
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    Intent toSalesTwo = new Intent(getApplicationContext(), Sls_Step_1.class);
                    toSalesTwo.putExtra("username-id", id);
                    toSalesTwo.putExtra("place", store);
                    toSalesTwo.putExtra("edp", edp);
                    startActivity(toSalesTwo);
            }
        });
    ...
    private class UploadTask extends AsyncTask<Bitmap, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(SalesActivity.this, R.string.uploaded, Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void setPic() {
        ...
        //Bitmap imgBMP = Bitmap.createBitmap(bitmap, 0, 0, bitmap.getWidth(), bitmap.getHeight());
