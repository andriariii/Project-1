...
public class Sls_step_5 extends ActionBarActivity {

    JSONParser jsonParser = new JSONParser();
    ProgressDialog pDialog;

    private static final String LOGIN_URL = "http://wearedreamblend.com/bata/insert.g.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sls_step_5);
        ...
        rg1 = (RadioGroup) findViewById(R.id.A8_1_Option);
        rg2 = (RadioGroup) findViewById(R.id.A8_2_Option);
        rg3 = (RadioGroup) findViewById(R.id.A8_3_Option);
        rg4 = (RadioGroup) findViewById(R.id.A8_4_Option);
        rg5 = (RadioGroup) findViewById(R.id.A8_5_Option);
        rg6 = (RadioGroup) findViewById(R.id.A8_6_Option);
        rg7 = (RadioGroup) findViewById(R.id.A8_7_Option);
        rg8 = (RadioGroup) findViewById(R.id.A8_8_Option);
        rg9 = (RadioGroup) findViewById(R.id.A8_9_Option);

        btnNext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toDashboard = new Intent(getApplicationContext(), Sls_step_6.class);
    ...
    class login extends AsyncTask<String, String, String> {
        ...
        protected  void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Sls_step_5.this);
